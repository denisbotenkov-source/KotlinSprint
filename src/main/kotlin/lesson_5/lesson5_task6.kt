...
fun main() {
    ...
    if (bmi < 18.5) println("Insufficient body weight.")
    else if (bmi > 18.5 && bmi < 25 ) println("Normal body weight.")
    else if (bmi > 25 && bmi < 30) println("Excess body weight.")
    else if (bmi >= 30) println("Fatness.")
}